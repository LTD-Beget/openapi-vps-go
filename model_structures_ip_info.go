...
// checks if the StructuresIpInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StructuresIpInfo{}
...
func (o StructuresIpInfo) ToMap() (map[string]interface{}, error) {
