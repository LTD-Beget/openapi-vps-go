...
```golang
import begetOpenapiVps "github.com/LTD-Beget/openapi-go/vps"
```
...
*ManageServiceApi* | [**ManageServiceGetSoftwareList**](docs/ManageServiceApi.md#manageservicegetsoftwarelist) | **Get** /v1/vps/software | 
...
## Documentation For Models
 ...
 - [ManageGetSoftwareListResponse](docs/ManageGetSoftwareListResponse.md)
 - [ManageGetSoftwareListResponseSoftwareInfo](docs/ManageGetSoftwareListResponseSoftwareInfo.md)
 - [ManageGetSoftwareListResponseSoftwareInfoRequirements](docs/ManageGetSoftwareListResponseSoftwareInfoRequirements.md)
 ...
 - [MarketplaceGetSoftwareListResponseSoftwareInfo](docs/MarketplaceGetSoftwareListResponseSoftwareInfo.md)
 - [MarketplaceGetSoftwareListResponseSoftwareInfoRequirements](docs/MarketplaceGetSoftwareListResponseSoftwareInfoRequirements.md)
