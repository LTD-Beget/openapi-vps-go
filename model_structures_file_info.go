...
// checks if the StructuresFileInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StructuresFileInfo{}
...
func (o StructuresFileInfo) ToMap() (map[string]interface{}, error) {
