...
// checks if the ManageConfigurationGroup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageConfigurationGroup{}
...
func (o ManageConfigurationGroup) ToMap() (map[string]interface{}, error) {
