...
// checks if the BackupRestoreServerRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BackupRestoreServerRequest{}
...
func (o BackupRestoreServerRequest) ToMap() (map[string]interface{}, error) {
