...
// checks if the StructuresSoftwareLicenseBillingType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StructuresSoftwareLicenseBillingType{}
...
func (o StructuresSoftwareLicenseBillingType) ToMap() (map[string]interface{}, error) {
