...
// checks if the ManagePrivateNetworkInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManagePrivateNetworkInfo{}
...
func (o ManagePrivateNetworkInfo) ToMap() (map[string]interface{}, error) {
