...
// checks if the ManageUnarchiveResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageUnarchiveResponse{}
...
func (o ManageUnarchiveResponse) ToMap() (map[string]interface{}, error) {
