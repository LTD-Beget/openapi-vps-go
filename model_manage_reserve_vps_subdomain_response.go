...
// checks if the ManageReserveVpsSubdomainResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageReserveVpsSubdomainResponse{}
...
func (o ManageReserveVpsSubdomainResponse) ToMap() (map[string]interface{}, error) {
