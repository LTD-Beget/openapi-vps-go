...
// checks if the ManageCheckSoftwareRequirementsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageCheckSoftwareRequirementsRequest{}
...
func (o ManageCheckSoftwareRequirementsRequest) ToMap() (map[string]interface{}, error) {
