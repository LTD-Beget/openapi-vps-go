...
// checks if the ManageRemoveVpsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageRemoveVpsResponse{}
...
func (o ManageRemoveVpsResponse) ToMap() (map[string]interface{}, error) {
