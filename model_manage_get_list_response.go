...
// checks if the ManageGetListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageGetListResponse{}
...
func (o ManageGetListResponse) ToMap() (map[string]interface{}, error) {
