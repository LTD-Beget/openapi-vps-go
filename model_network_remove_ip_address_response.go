...
// checks if the NetworkRemoveIpAddressResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkRemoveIpAddressResponse{}
...
func (o NetworkRemoveIpAddressResponse) ToMap() (map[string]interface{}, error) {
