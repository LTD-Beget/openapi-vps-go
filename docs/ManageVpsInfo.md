...
`func (o *ManageVpsInfo) GetDisplayRank() string`

GetDisplayRank returns the DisplayRank field if non-nil, zero value otherwise.

### GetDisplayRankOk

`func (o *ManageVpsInfo) GetDisplayRankOk() (*string, bool)`
...
`func (o *ManageVpsInfo) SetDisplayRank(v string)`

SetDisplayRank sets DisplayRank field to given value.

### HasDisplayRank

`func (o *ManageVpsInfo) HasDisplayRank() bool`
