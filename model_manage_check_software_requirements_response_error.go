...
// checks if the ManageCheckSoftwareRequirementsResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageCheckSoftwareRequirementsResponseError{}
...
func (o ManageCheckSoftwareRequirementsResponseError) ToMap() (map[string]interface{}, error) {
