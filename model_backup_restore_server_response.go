...
// checks if the BackupRestoreServerResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BackupRestoreServerResponse{}
...
func (o BackupRestoreServerResponse) ToMap() (map[string]interface{}, error) {
