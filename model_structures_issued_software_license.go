...
// checks if the StructuresIssuedSoftwareLicense type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StructuresIssuedSoftwareLicense{}
...
func (o StructuresIssuedSoftwareLicense) ToMap() (map[string]interface{}, error) {
