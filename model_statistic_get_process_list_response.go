...
// checks if the StatisticGetProcessListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StatisticGetProcessListResponse{}
...
func (o StatisticGetProcessListResponse) ToMap() (map[string]interface{}, error) {
