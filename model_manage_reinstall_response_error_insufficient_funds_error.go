...
// checks if the ManageReinstallResponseErrorInsufficientFundsError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageReinstallResponseErrorInsufficientFundsError{}
...
func (o ManageReinstallResponseErrorInsufficientFundsError) ToMap() (map[string]interface{}, error) {
