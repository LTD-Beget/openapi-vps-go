...
// checks if the ManageGetInfoResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageGetInfoResponse{}
...
func (o ManageGetInfoResponse) ToMap() (map[string]interface{}, error) {
