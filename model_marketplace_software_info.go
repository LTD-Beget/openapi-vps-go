...
// checks if the MarketplaceSoftwareInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarketplaceSoftwareInfo{}
...
func (o MarketplaceSoftwareInfo) ToMap() (map[string]interface{}, error) {
