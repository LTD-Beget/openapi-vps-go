...
// checks if the ManageChangeSshAccessResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageChangeSshAccessResponseError{}
...
func (o ManageChangeSshAccessResponseError) ToMap() (map[string]interface{}, error) {
