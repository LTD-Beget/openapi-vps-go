...
// checks if the SoftwareLicenseGetLicenseInfoResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SoftwareLicenseGetLicenseInfoResponse{}
...
func (o SoftwareLicenseGetLicenseInfoResponse) ToMap() (map[string]interface{}, error) {
