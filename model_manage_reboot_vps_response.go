...
// checks if the ManageRebootVpsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageRebootVpsResponse{}
...
func (o ManageRebootVpsResponse) ToMap() (map[string]interface{}, error) {
