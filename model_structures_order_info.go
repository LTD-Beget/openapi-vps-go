...
// checks if the StructuresOrderInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StructuresOrderInfo{}
...
func (o StructuresOrderInfo) ToMap() (map[string]interface{}, error) {
