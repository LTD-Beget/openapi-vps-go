...
// checks if the StatisticGetDiskResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StatisticGetDiskResponse{}
...
func (o StatisticGetDiskResponse) ToMap() (map[string]interface{}, error) {
