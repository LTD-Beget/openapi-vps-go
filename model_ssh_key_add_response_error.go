...
// checks if the SshKeyAddResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SshKeyAddResponseError{}
...
func (o SshKeyAddResponseError) ToMap() (map[string]interface{}, error) {
