...
// checks if the StatisticGetLoadAverageResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StatisticGetLoadAverageResponse{}
...
func (o StatisticGetLoadAverageResponse) ToMap() (map[string]interface{}, error) {
