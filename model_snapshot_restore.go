...
// checks if the SnapshotRestore type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SnapshotRestore{}
...
func (o SnapshotRestore) ToMap() (map[string]interface{}, error) {
