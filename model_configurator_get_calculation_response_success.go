...
// checks if the ConfiguratorGetCalculationResponseSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConfiguratorGetCalculationResponseSuccess{}
...
func (o ConfiguratorGetCalculationResponseSuccess) ToMap() (map[string]interface{}, error) {
