...
// checks if the StructuresCopyInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StructuresCopyInfo{}
...
func (o StructuresCopyInfo) ToMap() (map[string]interface{}, error) {
