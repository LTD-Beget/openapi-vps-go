...
// checks if the ManageAttachIpAddressRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageAttachIpAddressRequest{}
...
func (o ManageAttachIpAddressRequest) ToMap() (map[string]interface{}, error) {
