...
func (a *MarketplaceServiceApiService) MarketplaceServiceGetSoftwareListExecute(r ApiMarketplaceServiceGetSoftwareListRequest) (*MarketplaceGetSoftwareListResponse, *http.Response, error) {
	...
	if r.categoryName != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "category_name", r.categoryName, "")
	}
	if r.displayName != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "display_name", r.displayName, "")
	}
	if r.isPinned != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "is_pinned", r.isPinned, "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
