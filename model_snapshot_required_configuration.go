...
// checks if the SnapshotRequiredConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SnapshotRequiredConfiguration{}
...
func (o SnapshotRequiredConfiguration) ToMap() (map[string]interface{}, error) {
