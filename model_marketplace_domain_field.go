...
// checks if the MarketplaceDomainField type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarketplaceDomainField{}
...
func (o MarketplaceDomainField) ToMap() (map[string]interface{}, error) {
