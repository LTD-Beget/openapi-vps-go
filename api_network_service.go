...
type ApiNetworkServiceCreatePrivateNetworkRequest struct {
	...
	networkCreatePrivateNetworkRequest *NetworkCreatePrivateNetworkRequest
}

func (r ApiNetworkServiceCreatePrivateNetworkRequest) NetworkCreatePrivateNetworkRequest(networkCreatePrivateNetworkRequest NetworkCreatePrivateNetworkRequest) ApiNetworkServiceCreatePrivateNetworkRequest {
	r.networkCreatePrivateNetworkRequest = &networkCreatePrivateNetworkRequest
	return r
}
...
func (a *NetworkServiceApiService) NetworkServiceCreatePrivateNetworkExecute(r ApiNetworkServiceCreatePrivateNetworkRequest) (*NetworkCreatePrivateNetworkResponse, *http.Response, error) {
	...
	if r.networkCreatePrivateNetworkRequest == nil {
		return localVarReturnValue, nil, reportError("networkCreatePrivateNetworkRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.networkCreatePrivateNetworkRequest
...
func (r ApiNetworkServiceGetNetworkInfoRequest) Filter(filter string) ApiNetworkServiceGetNetworkInfoRequest {
	r.filter = &filter
	return r
}
...
type ApiNetworkServiceRemovePrivateNetworkRequest struct {
	ctx context.Context
	ApiService *NetworkServiceApiService
	networkId string
}

func (r ApiNetworkServiceRemovePrivateNetworkRequest) Execute() (*NetworkRemovePrivateNetworkResponse, *http.Response, error) {
	return r.ApiService.NetworkServiceRemovePrivateNetworkExecute(r)
}

/*
NetworkServiceRemovePrivateNetwork Method for NetworkServiceRemovePrivateNetwork

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param networkId
 @return ApiNetworkServiceRemovePrivateNetworkRequest
*/
func (a *NetworkServiceApiService) NetworkServiceRemovePrivateNetwork(ctx context.Context, networkId string) ApiNetworkServiceRemovePrivateNetworkRequest {
	return ApiNetworkServiceRemovePrivateNetworkRequest{
		ApiService: a,
		ctx: ctx,
		networkId: networkId,
...
// Execute executes the request
//  @return NetworkRemovePrivateNetworkResponse
func (a *NetworkServiceApiService) NetworkServiceRemovePrivateNetworkExecute(r ApiNetworkServiceRemovePrivateNetworkRequest) (*NetworkRemovePrivateNetworkResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *NetworkRemovePrivateNetworkResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "NetworkServiceApiService.NetworkServiceRemovePrivateNetwork")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/vps/private-network/{network_id}"
