...
type ApiManageServiceRemoveVpsRequest struct {
	...
	ApiService *ManageServiceApiService
	id string
	manageRemoveVpsRequest *ManageRemoveVpsRequest
}

func (r ApiManageServiceRemoveVpsRequest) ManageRemoveVpsRequest(manageRemoveVpsRequest ManageRemoveVpsRequest) ApiManageServiceRemoveVpsRequest {
	r.manageRemoveVpsRequest = &manageRemoveVpsRequest
	return r
}
...
func (a *ManageServiceApiService) ManageServiceRemoveVpsExecute(r ApiManageServiceRemoveVpsRequest) (*ManageRemoveVpsResponse, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.manageRemoveVpsRequest == nil {
		return localVarReturnValue, nil, reportError("manageRemoveVpsRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.manageRemoveVpsRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
