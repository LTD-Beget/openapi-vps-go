...
type ApiManageServiceGetSoftwareListRequest struct {
	ctx context.Context
	ApiService *ManageServiceApiService
}

func (r ApiManageServiceGetSoftwareListRequest) Execute() (*ManageGetSoftwareListResponse, *http.Response, error) {
	return r.ApiService.ManageServiceGetSoftwareListExecute(r)
}

/*
ManageServiceGetSoftwareList Method for ManageServiceGetSoftwareList

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiManageServiceGetSoftwareListRequest
*/
func (a *ManageServiceApiService) ManageServiceGetSoftwareList(ctx context.Context) ApiManageServiceGetSoftwareListRequest {
	return ApiManageServiceGetSoftwareListRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ManageGetSoftwareListResponse
func (a *ManageServiceApiService) ManageServiceGetSoftwareListExecute(r ApiManageServiceGetSoftwareListRequest) (*ManageGetSoftwareListResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ManageGetSoftwareListResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ManageServiceApiService.ManageServiceGetSoftwareList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/vps/software"
