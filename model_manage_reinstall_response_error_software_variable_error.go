...
// checks if the ManageReinstallResponseErrorSoftwareVariableError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageReinstallResponseErrorSoftwareVariableError{}
...
func (o ManageReinstallResponseErrorSoftwareVariableError) ToMap() (map[string]interface{}, error) {
