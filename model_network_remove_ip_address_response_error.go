...
// checks if the NetworkRemoveIpAddressResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkRemoveIpAddressResponseError{}
...
func (o NetworkRemoveIpAddressResponseError) ToMap() (map[string]interface{}, error) {
