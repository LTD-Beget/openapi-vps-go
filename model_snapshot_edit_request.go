...
// checks if the SnapshotEditRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SnapshotEditRequest{}
...
func (o SnapshotEditRequest) ToMap() (map[string]interface{}, error) {
