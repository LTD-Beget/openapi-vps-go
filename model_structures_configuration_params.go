...
// checks if the StructuresConfigurationParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StructuresConfigurationParams{}
...
func (o StructuresConfigurationParams) ToMap() (map[string]interface{}, error) {
