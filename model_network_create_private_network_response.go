...
// checks if the NetworkCreatePrivateNetworkResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkCreatePrivateNetworkResponse{}
...
func (o NetworkCreatePrivateNetworkResponse) ToMap() (map[string]interface{}, error) {
