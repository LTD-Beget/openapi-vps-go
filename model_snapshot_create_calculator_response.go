...
// checks if the SnapshotCreateCalculatorResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SnapshotCreateCalculatorResponse{}
...
func (o SnapshotCreateCalculatorResponse) ToMap() (map[string]interface{}, error) {
