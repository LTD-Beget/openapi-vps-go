...
// checks if the ManageStopVpsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageStopVpsResponse{}
...
func (o ManageStopVpsResponse) ToMap() (map[string]interface{}, error) {
