...
// checks if the ManageStopRescueResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageStopRescueResponse{}
...
func (o ManageStopRescueResponse) ToMap() (map[string]interface{}, error) {
