...
// checks if the ManageChangeSshAccessResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageChangeSshAccessResponse{}
...
func (o ManageChangeSshAccessResponse) ToMap() (map[string]interface{}, error) {
