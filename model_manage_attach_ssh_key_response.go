...
// checks if the ManageAttachSshKeyResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageAttachSshKeyResponse{}
...
func (o ManageAttachSshKeyResponse) ToMap() (map[string]interface{}, error) {
