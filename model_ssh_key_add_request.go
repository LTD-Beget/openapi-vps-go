...
// checks if the SshKeyAddRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SshKeyAddRequest{}
...
func (o SshKeyAddRequest) ToMap() (map[string]interface{}, error) {
