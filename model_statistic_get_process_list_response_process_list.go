...
// checks if the StatisticGetProcessListResponseProcessList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StatisticGetProcessListResponseProcessList{}
...
func (o StatisticGetProcessListResponseProcessList) ToMap() (map[string]interface{}, error) {
