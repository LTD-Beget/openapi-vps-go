...
// checks if the ManageGetRegionListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageGetRegionListResponse{}
...
func (o ManageGetRegionListResponse) ToMap() (map[string]interface{}, error) {
