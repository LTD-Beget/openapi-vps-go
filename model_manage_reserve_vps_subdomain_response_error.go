...
// checks if the ManageReserveVpsSubdomainResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageReserveVpsSubdomainResponseError{}
...
func (o ManageReserveVpsSubdomainResponseError) ToMap() (map[string]interface{}, error) {
