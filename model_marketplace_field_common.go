...
// checks if the MarketplaceFieldCommon type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarketplaceFieldCommon{}
...
func (o MarketplaceFieldCommon) ToMap() (map[string]interface{}, error) {
