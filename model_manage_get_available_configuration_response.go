...
// checks if the ManageGetAvailableConfigurationResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageGetAvailableConfigurationResponse{}
...
type ManageGetAvailableConfigurationResponse struct {
	...
	ConfigurationGroups []ManageConfigurationGroup `json:"configuration_groups,omitempty"`
}
...
// GetConfigurationGroups returns the ConfigurationGroups field value if set, zero value otherwise.
func (o *ManageGetAvailableConfigurationResponse) GetConfigurationGroups() []ManageConfigurationGroup {
	if o == nil || IsNil(o.ConfigurationGroups) {
		var ret []ManageConfigurationGroup
		return ret
	}
	return o.ConfigurationGroups
}

// GetConfigurationGroupsOk returns a tuple with the ConfigurationGroups field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ManageGetAvailableConfigurationResponse) GetConfigurationGroupsOk() ([]ManageConfigurationGroup, bool) {
	if o == nil || IsNil(o.ConfigurationGroups) {
		return nil, false
	}
	return o.ConfigurationGroups, true
}
...
// SetConfigurationGroups gets a reference to the given []ManageConfigurationGroup and assigns it to the ConfigurationGroups field.
func (o *ManageGetAvailableConfigurationResponse) SetConfigurationGroups(v []ManageConfigurationGroup) {
	o.ConfigurationGroups = v
}
...
func (o ManageGetAvailableConfigurationResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Configurations) {
		toSerialize["configurations"] = o.Configurations
	}
	if !IsNil(o.ConfigurationGroups) {
		toSerialize["configuration_groups"] = o.ConfigurationGroups
	}
