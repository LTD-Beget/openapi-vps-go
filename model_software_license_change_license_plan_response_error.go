...
// checks if the SoftwareLicenseChangeLicensePlanResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SoftwareLicenseChangeLicensePlanResponseError{}
...
func (o SoftwareLicenseChangeLicensePlanResponseError) ToMap() (map[string]interface{}, error) {
