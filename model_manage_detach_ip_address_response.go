...
// checks if the ManageDetachIpAddressResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageDetachIpAddressResponse{}
...
func (o ManageDetachIpAddressResponse) ToMap() (map[string]interface{}, error) {
