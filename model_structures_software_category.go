...
// checks if the StructuresSoftwareCategory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StructuresSoftwareCategory{}
...
func (o StructuresSoftwareCategory) ToMap() (map[string]interface{}, error) {
