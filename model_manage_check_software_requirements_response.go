...
// checks if the ManageCheckSoftwareRequirementsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageCheckSoftwareRequirementsResponse{}
...
func (o ManageCheckSoftwareRequirementsResponse) ToMap() (map[string]interface{}, error) {
