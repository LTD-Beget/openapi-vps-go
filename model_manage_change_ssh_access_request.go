...
// checks if the ManageChangeSshAccessRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageChangeSshAccessRequest{}
...
func (o ManageChangeSshAccessRequest) ToMap() (map[string]interface{}, error) {
