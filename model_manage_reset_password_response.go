...
// checks if the ManageResetPasswordResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageResetPasswordResponse{}
...
func (o ManageResetPasswordResponse) ToMap() (map[string]interface{}, error) {
