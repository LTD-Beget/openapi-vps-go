...
// checks if the ManageSoftwareInstallInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageSoftwareInstallInfo{}
...
func (o ManageSoftwareInstallInfo) ToMap() (map[string]interface{}, error) {
