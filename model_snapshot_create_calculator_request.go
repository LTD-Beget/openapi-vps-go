...
// checks if the SnapshotCreateCalculatorRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SnapshotCreateCalculatorRequest{}
...
func (o SnapshotCreateCalculatorRequest) ToMap() (map[string]interface{}, error) {
