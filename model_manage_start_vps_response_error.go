...
// checks if the ManageStartVpsResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageStartVpsResponseError{}
...
func (o ManageStartVpsResponseError) ToMap() (map[string]interface{}, error) {
