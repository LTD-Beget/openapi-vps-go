...
// checks if the ManageReinstallResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageReinstallResponse{}
...
func (o ManageReinstallResponse) ToMap() (map[string]interface{}, error) {
