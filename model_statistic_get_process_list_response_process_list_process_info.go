...
// checks if the StatisticGetProcessListResponseProcessListProcessInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StatisticGetProcessListResponseProcessListProcessInfo{}
...
func (o StatisticGetProcessListResponseProcessListProcessInfo) ToMap() (map[string]interface{}, error) {
