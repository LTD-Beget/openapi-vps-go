...
// checks if the SshKeyAddResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SshKeyAddResponse{}
...
func (o SshKeyAddResponse) ToMap() (map[string]interface{}, error) {
