...
// checks if the ManageChangeConfigurationResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageChangeConfigurationResponse{}
...
func (o ManageChangeConfigurationResponse) ToMap() (map[string]interface{}, error) {
