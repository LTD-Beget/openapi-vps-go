...
// checks if the SshKeyRemoveResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SshKeyRemoveResponse{}
...
func (o SshKeyRemoveResponse) ToMap() (map[string]interface{}, error) {
