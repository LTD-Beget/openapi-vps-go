...
// checks if the ManageDetachFromPrivateNetworkResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageDetachFromPrivateNetworkResponse{}
...
func (o ManageDetachFromPrivateNetworkResponse) ToMap() (map[string]interface{}, error) {
