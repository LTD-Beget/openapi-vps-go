...
// checks if the SnapshotSnapshot type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SnapshotSnapshot{}
...
type SnapshotSnapshot struct {
	...
	VpsExists *bool `json:"vps_exists,omitempty"`
...
// GetVpsExists returns the VpsExists field value if set, zero value otherwise.
func (o *SnapshotSnapshot) GetVpsExists() bool {
	if o == nil || IsNil(o.VpsExists) {
		var ret bool
		return ret
	}
	return *o.VpsExists
...
// GetVpsExistsOk returns a tuple with the VpsExists field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SnapshotSnapshot) GetVpsExistsOk() (*bool, bool) {
	if o == nil || IsNil(o.VpsExists) {
		return nil, false
	}
	return o.VpsExists, true
}
...
// SetVpsExists gets a reference to the given bool and assigns it to the VpsExists field.
...
func (o SnapshotSnapshot) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.VpsExists) {
		toSerialize["vps_exists"] = o.VpsExists
	}
