...
// checks if the ManageResetVpsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageResetVpsResponse{}
...
func (o ManageResetVpsResponse) ToMap() (map[string]interface{}, error) {
