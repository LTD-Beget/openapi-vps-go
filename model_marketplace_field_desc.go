...
// checks if the MarketplaceFieldDesc type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarketplaceFieldDesc{}
...
func (o MarketplaceFieldDesc) ToMap() (map[string]interface{}, error) {
