...
// checks if the StructuresInstalledSoftwareInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StructuresInstalledSoftwareInfo{}
...
func (o StructuresInstalledSoftwareInfo) ToMap() (map[string]interface{}, error) {
