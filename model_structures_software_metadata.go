...
// checks if the StructuresSoftwareMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StructuresSoftwareMetadata{}
...
func (o StructuresSoftwareMetadata) ToMap() (map[string]interface{}, error) {
