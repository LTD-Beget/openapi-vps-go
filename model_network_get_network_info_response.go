...
// checks if the NetworkGetNetworkInfoResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkGetNetworkInfoResponse{}
...
func (o NetworkGetNetworkInfoResponse) ToMap() (map[string]interface{}, error) {
