...
// checks if the ManageStartVpsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageStartVpsResponse{}
...
func (o ManageStartVpsResponse) ToMap() (map[string]interface{}, error) {
