...
type MarketplaceGetSoftwareListResponse struct {
	Software []MarketplaceGetSoftwareListResponseSoftwareInfo `json:"software,omitempty"`
}
...
func (o *MarketplaceGetSoftwareListResponse) GetSoftware() []MarketplaceGetSoftwareListResponseSoftwareInfo {
	if o == nil || isNil(o.Software) {
		var ret []MarketplaceGetSoftwareListResponseSoftwareInfo
		return ret
	}
	return o.Software
}
...
// SetSoftware gets a reference to the given []MarketplaceGetSoftwareListResponseSoftwareInfo and assigns it to the Software field.
