...
// checks if the ManageAttachIpAddressResponseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageAttachIpAddressResponseError{}
...
func (o ManageAttachIpAddressResponseError) ToMap() (map[string]interface{}, error) {
