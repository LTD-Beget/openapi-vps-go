...
// checks if the StructuresCopyInfoConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StructuresCopyInfoConfiguration{}
...
func (o StructuresCopyInfoConfiguration) ToMap() (map[string]interface{}, error) {
