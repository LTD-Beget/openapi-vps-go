...
// checks if the MarketplaceTextField type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarketplaceTextField{}
...
func (o MarketplaceTextField) ToMap() (map[string]interface{}, error) {
