...
// checks if the ManageCreateVpsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageCreateVpsRequest{}
...
type ManageCreateVpsRequest struct {
	...
	NetworkInterfaces []ManageNetworkInterface `json:"network_interfaces,omitempty"`
}
...
func (o *ManageCreateVpsRequest) GetNetworkInterfaces() []ManageNetworkInterface {
	if o == nil || IsNil(o.NetworkInterfaces) {
		var ret []ManageNetworkInterface
		return ret
	}
...
// SetNetworkInterfaces gets a reference to the given []ManageNetworkInterface and assigns it to the NetworkInterfaces field.
...
func (o ManageCreateVpsRequest) ToMap() (map[string]interface{}, error) {
