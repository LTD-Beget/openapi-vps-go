...
// checks if the ConfiguratorCpuSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConfiguratorCpuSettings{}
...
func (o ConfiguratorCpuSettings) ToMap() (map[string]interface{}, error) {
