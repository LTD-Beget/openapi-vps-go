...
// checks if the ManageAttachIpAddressResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageAttachIpAddressResponse{}
...
func (o ManageAttachIpAddressResponse) ToMap() (map[string]interface{}, error) {
