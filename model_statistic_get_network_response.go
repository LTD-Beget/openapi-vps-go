...
// checks if the StatisticGetNetworkResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StatisticGetNetworkResponse{}
...
func (o StatisticGetNetworkResponse) ToMap() (map[string]interface{}, error) {
